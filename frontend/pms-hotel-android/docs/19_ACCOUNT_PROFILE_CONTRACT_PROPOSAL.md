...
La ruta y el entry point canónicos están definidos por `31_ACCOUNT_PROFILE_CHANGE_CONTROL.md`: `IMP-AND-0202` implementará `/account/profile` y `IMP-AND-0303` queda absorbida. La UI debe consumir Guest Navigation V3.
