...
Rewards read models and ledger presentation.
...
May consume intentional public APIs from: account, reservations.
...
Cross-module dependencies use `@/modules/rewards`, never paths such as `@/modules/rewards/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Public 05 Rewards. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
