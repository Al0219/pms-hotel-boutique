...
Public booking, multi-room draft, and public room-selection composition.
...
May consume intentional public APIs from: availability, rooms, auth, payments.
...
Cross-module dependencies use `@/modules/booking`, never paths such as `@/modules/booking/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Public 01 Booking and Public 03 Multi-room. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
