...
Maintenance orders, OOO/OOS, and operational status.
...
May consume intentional public APIs from: rooms, housekeeping, inventory.
...
Cross-module dependencies use `@/modules/maintenance`, never paths such as `@/modules/maintenance/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
