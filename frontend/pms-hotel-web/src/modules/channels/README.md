...
Distribution channel and channel-mix presentation.
...
May consume intentional public APIs from: rates, availability, integrations, revenue.
...
Cross-module dependencies use `@/modules/channels`, never paths such as `@/modules/channels/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
