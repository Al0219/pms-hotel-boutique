...
Physical inventory and sellable-impact presentation.
...
May consume intentional public APIs from: rooms, maintenance, availability.
...
Cross-module dependencies use `@/modules/inventory`, never paths such as `@/modules/inventory/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
