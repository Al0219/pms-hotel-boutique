...
Group lifecycle, room blocks, pickup, rooming lists, and master folio composition.
...
May consume intentional public APIs from: reservations, stays, folio, availability.
...
Cross-module dependencies use `@/modules/groups`, never paths such as `@/modules/groups/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
