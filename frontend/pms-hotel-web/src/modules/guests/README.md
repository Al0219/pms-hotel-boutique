...
Guest identity and CRM-facing guest presentation.
...
May consume intentional public APIs from: profile, crm, reservations.
...
Cross-module dependencies use `@/modules/guests`, never paths such as `@/modules/guests/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Guest/Profile semantics and Private Reservation Engine. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
