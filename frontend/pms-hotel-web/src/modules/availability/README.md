...
Sellable availability and ATS presentation, separate from physical inventory.
...
May consume intentional public APIs from: rates, inventory, reservations, rooms.
...
Cross-module dependencies use `@/modules/availability`, never paths such as `@/modules/availability/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private 04 Commercial / Availability / Revenue. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
