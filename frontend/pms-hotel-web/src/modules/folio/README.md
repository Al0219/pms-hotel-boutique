...
Guest, company, and master folio presentation.
...
May consume intentional public APIs from: payments, receivables, reservations, groups.
...
Cross-module dependencies use `@/modules/folio`, never paths such as `@/modules/folio/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private 02 Folio & Payments. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
