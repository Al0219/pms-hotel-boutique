...
Integration Center, health, mappings, and error-queue presentation.
...
May consume intentional public APIs from: channels, payments, security, properties.
...
Cross-module dependencies use `@/modules/integrations`, never paths such as `@/modules/integrations/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private 06 Integrations. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
