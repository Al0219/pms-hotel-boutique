...
GuestProfile identity and contact presentation independent of GuestAccount.
...
May consume intentional public APIs from: account, guests.
...
Cross-module dependencies use `@/modules/profile`, never paths such as `@/modules/profile/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Public 05 Account and profile. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
