...
Payment lifecycle presentation without PAN or CVV.
...
May consume intentional public APIs from: folio, receivables, checkout.
...
Cross-module dependencies use `@/modules/payments`, never paths such as `@/modules/payments/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
