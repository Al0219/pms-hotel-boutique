...
Physical Room operational semantics and room operations presentation.
...
May consume intentional public APIs from: stays, housekeeping, maintenance, inventory.
...
Cross-module dependencies use `@/modules/rooms`, never paths such as `@/modules/rooms/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private Rooms and Operations. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
