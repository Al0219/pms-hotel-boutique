...
Operational messaging routed through Reception.
...
May consume intentional public APIs from: concierge, guests, reservations.
...
Cross-module dependencies use `@/modules/messaging`, never paths such as `@/modules/messaging/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Reception messaging and Operations. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
