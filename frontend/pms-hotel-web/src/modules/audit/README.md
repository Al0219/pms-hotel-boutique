...
AuditTrail presentation for sensitive, append-only history.
...
May consume intentional public APIs from: security, permissions, reservations, payments.
...
Cross-module dependencies use `@/modules/audit`, never paths such as `@/modules/audit/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private audit and compliance. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
