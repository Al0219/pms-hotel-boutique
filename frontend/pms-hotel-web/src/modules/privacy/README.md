...
Consent, privacy, and DSR presentation.
...
May consume intentional public APIs from: account, profile, security.
...
Cross-module dependencies use `@/modules/privacy`, never paths such as `@/modules/privacy/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
