...
CRM-facing guest relationships and customer-management presentation.
...
May consume intentional public APIs from: guests, profile, properties.
...
Cross-module dependencies use `@/modules/crm`, never paths such as `@/modules/crm/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private CRM. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
