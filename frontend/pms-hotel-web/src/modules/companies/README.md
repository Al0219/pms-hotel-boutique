...
Company B2B presentation and property-scoped agreements.
...
May consume intentional public APIs from: agencies, groups, receivables, folio.
...
Cross-module dependencies use `@/modules/companies`, never paths such as `@/modules/companies/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
