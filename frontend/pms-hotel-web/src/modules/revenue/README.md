...
Revenue metrics and forecasting presentation.
...
May consume intentional public APIs from: availability, rates, channels, properties.
...
Cross-module dependencies use `@/modules/revenue`, never paths such as `@/modules/revenue/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
