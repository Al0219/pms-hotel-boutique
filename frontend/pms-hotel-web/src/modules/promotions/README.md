...
Promotion eligibility and presentation.
...
May consume intentional public APIs from: booking, checkout, rates.
...
Cross-module dependencies use `@/modules/promotions`, never paths such as `@/modules/promotions/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Public 05 Promotions. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
