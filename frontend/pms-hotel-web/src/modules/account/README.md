...
Guest account access, linked reservation history, and account preferences.
...
May consume intentional public APIs from: auth, profile, reservations, rewards, promotions.
...
Cross-module dependencies use `@/modules/account`, never paths such as `@/modules/account/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Public 05 Account, history, rewards and promotions. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
