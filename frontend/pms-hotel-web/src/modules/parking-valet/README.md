...
Parking and valet operations presentation.
...
May consume intentional public APIs from: reservations, guests.
...
Cross-module dependencies use `@/modules/parking-valet`, never paths such as `@/modules/parking-valet/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
