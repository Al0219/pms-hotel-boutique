...
Guest and staff authentication boundaries and client auth states.
...
May consume intentional public APIs from: account, profile.
...
Cross-module dependencies use `@/modules/auth`, never paths such as `@/modules/auth/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Public 02 Identity and account; Private 07 Security. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
