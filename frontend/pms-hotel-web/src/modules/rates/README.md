...
RatePlan and restrictions presentation.
...
May consume intentional public APIs from: availability, revenue, channels.
...
Cross-module dependencies use `@/modules/rates`, never paths such as `@/modules/rates/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
