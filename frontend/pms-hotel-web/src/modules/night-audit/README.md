...
Night Audit presentation and business-date closing controls.
...
May consume intentional public APIs from: folio, payments, reservations, properties.
...
Cross-module dependencies use `@/modules/night-audit`, never paths such as `@/modules/night-audit/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private compliance and Night Audit. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
