...
ReservationStay presentation and stay-level operations.
...
May consume intentional public APIs from: reservations, rooms, availability.
...
Cross-module dependencies use `@/modules/stays`, never paths such as `@/modules/stays/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
