...
Purchasing and procurement presentation.
...
May consume intentional public APIs from: inventory, properties.
...
Cross-module dependencies use `@/modules/purchases`, never paths such as `@/modules/purchases/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
...
Private management purchases. Consult relevant global domain documents, Web architecture, module boundaries, ownership, and domain-specific Web documentation. No Figma Node ID is invented here.
