...
Receivables and Direct Bill presentation.
...
May consume intentional public APIs from: folio, companies, agencies.
...
Cross-module dependencies use `@/modules/receivables`, never paths such as `@/modules/receivables/service/*`, `dtos/*`, `mappers/*`, `hooks/*`, or `components/*`.
