...
import { RebookingApplied, type MultiPropertyView } from "@/modules/multi-property";
import { useRouter } from "next/navigation";

export default function RebookingAppliedRoute() {
  ...
  return <RebookingApplied onNavigate={handleNavigate} />;
}
